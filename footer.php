<footer class="site__footer">
    <h2 class="footer__titre">Travail Pratique #1</h2>
    <h3 class="footer__author">Gabriel Devoyau-Lanctôt - Collège de Maisonneuve - &copy; 2022 </h3>
    <p class="footer_retour"><a href="/">Retour à l'accueil</a></p>
    <div class="contenu__footer">
        <?php 
            ...
            wp_nav_menu(array(
                                ...
                                "link_before"=>$icone)); ?>
        <div class="footer_barreRecherche">
            <h3>Recherchez sur le site...</h3>
            <?php get_search_form(); ?>
